...
export namespace dalledress {
  export class DalleDressPage {
    ...
    constructor(source: any = {}) {
      ...
      this.facet = source['facet'];
      this.logs = this.convertValues(source['logs'], types.Log);
      this.dalledress = this.convertValues(
        source['dalledress'],
        dalle.DalleDress,
      );
...
export namespace menu {
  ...
  export class MenuItem {
    ...
    constructor(source: any = {}) {
      ...
      this.Accelerator = this.convertValues(
        source['Accelerator'],
        keys.Accelerator,
      );
...
export namespace project {
  ...
  export class Project {
    ...
    constructor(source: any = {}) {
      ...
      this.activeAddress = this.convertValues(
      ...
      this.filterStates = this.convertValues(
        source['filterStates'],
        FilterState,
        true,
      );
...
export namespace types {
  ...
  export class FacetConfig {
    ...
    constructor(source: any = {}) {
      ...
      this.detailPanels = this.convertValues(
        source['detailPanels'],
        DetailPanelConfig,
      );
      this.actions = source['actions'];
  ...
  export class Log {
    ...
    constructor(source: any = {}) {
      if ('string' === typeof source) source = JSON.parse(source);
      this.address = this.convertValues(source['address'], base.Address);
      this.articulatedLog = this.convertValues(
        source['articulatedLog'],
        Function,
      );
      ...
      this.transactionHash = this.convertValues(
  ...
  export class Receipt {
    ...
    constructor(source: any = {}) {
      ...
      this.blockHash = this.convertValues(source['blockHash'], base.Hash);
      this.blockNumber = source['blockNumber'];
      this.contractAddress = this.convertValues(
  ...
  export class Statement {
    ...
    constructor(source: any = {}) {
      if ('string' === typeof source) source = JSON.parse(source);
      this.accountedFor = this.convertValues(
        source['accountedFor'],
        base.Address,
      );
      ...
      this.blockNumber = source['blockNumber'];
      this.correctAmountIn = this.convertValues(
        source['correctAmountIn'],
        null,
      );
      this.correctAmountOut = this.convertValues(
        source['correctAmountOut'],
        null,
      );
      this.correctBegBalIn = this.convertValues(
        source['correctBegBalIn'],
        null,
      );
      this.correctBegBalOut = this.convertValues(
        source['correctBegBalOut'],
        null,
      );
      this.correctEndBalIn = this.convertValues(
        source['correctEndBalIn'],
        null,
      );
      this.correctEndBalOut = this.convertValues(
        source['correctEndBalOut'],
        null,
      );
      ...
      this.logIndex = source['logIndex'];
      this.minerBaseRewardIn = this.convertValues(
        source['minerBaseRewardIn'],
        null,
      );
      this.minerNephewRewardIn = this.convertValues(
        source['minerNephewRewardIn'],
        null,
      );
      this.minerTxFeeIn = this.convertValues(source['minerTxFeeIn'], null);
      this.minerUncleRewardIn = this.convertValues(
        source['minerUncleRewardIn'],
        null,
      );
      ...
      this.selfDestructOut = this.convertValues(
        source['selfDestructOut'],
        null,
      );
  ...
  export class TraceAction {
    ...
    constructor(source: any = {}) {
      ...
      this.refundAddress = this.convertValues(
        source['refundAddress'],
        base.Address,
      );
      this.rewardType = source['rewardType'];
      this.selfDestructed = this.convertValues(
        source['selfDestructed'],
        base.Address,
      );
      this.to = this.convertValues(source['to'], base.Address);
  ...
  export class Trace {
    ...
    constructor(source: any = {}) {
      ...
      this.articulatedTrace = this.convertValues(
        source['articulatedTrace'],
        Function,
      );
      this.blockHash = this.convertValues(source['blockHash'], base.Hash);
      this.blockNumber = source['blockNumber'];
  ...
  export class Transaction {
    ...
    constructor(source: any = {}) {
      if ('string' === typeof source) source = JSON.parse(source);
      this.articulatedTx = this.convertValues(
        source['articulatedTx'],
        Function,
      );
      this.blockHash = this.convertValues(source['blockHash'], base.Hash);
      this.blockNumber = source['blockNumber'];
...
export namespace utils {
  ...
  export class ChainListItem {
    ...
    constructor(source: any = {}) {
      ...
      this.nativeCurrency = this.convertValues(
  ...
  export class ChainList {
    ...
    constructor(source: any = {}) {
      ...
      this.ChainsMap = this.convertValues(
        source['ChainsMap'],
        ChainListItem,
        true,
      );

...
export function DalleDressCrud(
  arg1: types.Payload,
  arg2: crud.Operation,
  arg3: any,
): Promise<void>;
...
export function GetChunksPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<chunks.ChunksPage>;

export function GetChunksSummary(arg1: types.Payload): Promise<types.Summary>;

export function GetComparitoorConfig(
  arg1: types.Payload,
): Promise<types.ViewConfig>;

export function GetComparitoorPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<comparitoor.ComparitoorPage>;

export function GetComparitoorSummary(
  arg1: types.Payload,
): Promise<types.Summary>;
...
export function GetContractsPage(
  ...
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<contracts.ContractsPage>;

export function GetContractsSummary(
  arg1: types.Payload,
): Promise<types.Summary>;

export function GetDalleAudioURL(
  arg1: types.Payload,
  arg2: string,
): Promise<string>;

export function GetDressesConfig(
  arg1: types.Payload,
): Promise<types.ViewConfig>;

export function GetDalleDressPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<dresses.DalleDressPage>;

export function GetDalleDressSummary(
  arg1: types.Payload,
): Promise<types.Summary>;
...
export function GetExportsConfig(
  arg1: types.Payload,
): Promise<types.ViewConfig>;

export function GetExportsPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<exports.ExportsPage>;
...
export function GetFilterState(
  arg1: project.ViewStateKey,
): Promise<project.FilterState>;
...
export function GetMonitorsConfig(
  arg1: types.Payload,
): Promise<types.ViewConfig>;

export function GetMonitorsPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
...
export function GetNamesPage(
  arg1: types.Payload,
  arg2: number,
  arg3: number,
  arg4: sdk.SortSpec,
  arg5: string,
): Promise<names.NamesPage>;
...
export function GetProjectViewState(
  arg1: string,
): Promise<Record<string, project.FilterState>>;
...
export function MonitorsClean(
  arg1: types.Payload,
  arg2: Array<string>,
): Promise<void>;

export function MonitorsCrud(
  arg1: types.Payload,
  arg2: crud.Operation,
  arg3: any,
): Promise<void>;
...
export function SetAppPreferences(
  arg1: preferences.AppPreferences,
): Promise<void>;
...
export function SetOrgPreferences(
  arg1: preferences.OrgPreferences,
): Promise<void>;

export function SetProjectAddress(arg1: base.Address): Promise<void>;

export function SetProjectViewState(
  arg1: string,
  arg2: Record<string, project.FilterState>,
): Promise<void>;
...
export function SetUserPreferences(
  arg1: preferences.UserPreferences,
): Promise<void>;
